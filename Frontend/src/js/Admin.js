function signin() {
  ...
  // console.log(user);
    ...
    axios.post('https://permis-backend-api.herokuapp.com/Admin/loginAdmin',user)
       .then((res) => {
               if(!res.data.message){ 
...
let rowAdmin = document.getElementById('nameAdmin');
  ...
  axios.get(`https://permis-backend-api.herokuapp.com/Admin`)
 .then((res) => {
...
axios.get('https://permis-backend-api.herokuapp.com/Admin/getAllConducteur')
...
function update(id){
    axios.get(`https://permis-backend-api.herokuapp.com/Admin/getConducteurById/${id}`)
    .then(function (response) {
    ...
    updateConducteur.addEventListener('click', () => {
        ...
        axios.put(`https://permis-backend-api.herokuapp.com/Admin/updateConducteur/${id}`,obj)
        .then(function (response) {
